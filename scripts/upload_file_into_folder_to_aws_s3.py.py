...
AWS_ACCESS_SECRET_KEY = aws_config.AWS_ACCESS_SECRET_KEY # put your IAM user's secret key
AWS_BUCKET_NAME = aws_config.AWS_BUCKET_NAME # put the name of the bucket
FILE_NAME=aws_config.FILE_NAME
FOLDER_TO_CREATE=aws_config.FOLDER_TO_CREATE
...
s3.Bucket(AWS_BUCKET_NAME).put_object(Key=FOLDER_TO_CREATE+'/'+FILE_NAME, Body=data)  # put the file into AWS bucket
